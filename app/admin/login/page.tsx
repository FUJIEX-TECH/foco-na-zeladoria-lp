        ...
        <form onSubmit={handleSubmit} className="bg-white border border-zinc-200 p-8 space-y-5">
          <div>
            ...
            <button
              ...
              className="flex items-center gap-1.5 mt-2 text-xs text-zinc-400 hover:text-zinc-600 transition-colors"
            >
              {showPass ? (
                <>
          ...
          <div className="text-center pt-1">
            <a
              href="https://wa.me/551176858031?text=Preciso+redefinir+a+senha+do+admin+do+Foco+na+Zeladoria"
              target="_blank"
